    ...
    <div class="col-xs-12">
        ...
        ">
            ...
            <div class="box-body">
                ...
                @else
                    Your panel is <strong>not up-to-date!</strong> The latest version is <a href="{{ $version->getPanelReleaseUrl() }}" target="_blank"><code>{{ $version->getPanel() }}</code></a> and you are currently running version <code>{{ config('app.version') }}</code>.
                @endif
            </div>
        </div>
    </div>
