                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div>
                                    <textarea class="form-control" name="app:footer_custom_text" rows="4" maxlength="1000" placeholder="&amp;copy; 2022-@{{current_year}} SKYLAB NETWORK">{{ old('app:footer_custom_text', config('app.footer_custom_text')) }}</textarea>
